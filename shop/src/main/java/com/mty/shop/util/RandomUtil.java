...
/**
 * @description:Used to produce a wide variety of IDs
 * @author: mwh
 */
public class RandomUtil {
        ...
        static {
            middle = MathUtils.makeUpNewData(Math.abs(NetworkUtils.getHostIP().hashCode()) + "", 4) +
                    MathUtils.makeUpNewData(NetworkUtils.getPid(), 4);
        }
...
//            String ss = DigestUtils.md5Hex(UUID.randomUUID().toString());
//            String str =  middle;
